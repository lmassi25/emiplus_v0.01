...
namespace Emiplus.Controller
{
    public class Bematech
    {
        ...
        public const string DLL = @"C:\Emiplus\MP2032.dll";
		...
		*/
        ...
        [DllImport(DLL)] public static extern int AcionaGuilhotina(int parcial_full);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int AjustaLarguraPapel(int iWidth);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int AutenticaDoc(String texto, int tempo);
        ...
        /// <param name="texto">STRING Texto a ser impresso</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int BematechTX(String texto);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ComandoTX(String comando, int tComando);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ConfiguraModeloImpressora(int model);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ConfiguraTamanhoExtrato(int tamanho);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ConfiguraTaxaSerial(int taxa);

        /// <summary>
        /// Objetivo de verificar a presença de documento antes da autenticação.
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int DocumentInserted();
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int EsperaImpressao(int modo);

        /// <summary>
        /// Esta função tem por objetivo fechar a porta de comunicação, liberando a porta para outras atividades.
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int FechaPorta();
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int FormataTX(String texto, int TipoLetra, int italico, int sublinhado, int expandido, int enfatizado);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int HabilitaEsperaImpressao(int espera);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int HabilitaExtratoLongo(int ExLongo);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int HabilitaPresenterRetratil(int iFlag);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int IniciaPorta(String porta);

        /// <summary>
        ///Esta função tem por objetivo retornar o estado da impressora.
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int Le_Status();

        /// <summary>
        /// Esta função retorna o estado da gaveta de dinheiro.
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int Le_Status_gaveta();

        /// <summary>
        /// Reset da impressora
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int PrinterReset();
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ProgramaPresenterRetratil(int iTempo);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int SelecionaQualidadeImpressao(int TipoQualidade);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int AtualizaFirmware(string Local);

        /// <summary>
        /// Verifica se há papel posicionado no Presenter.
        /// </summary>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int VerificaPapelPresenter();
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ConfiguraCodigoBarras(int Altura, int Largura, int Posicao, int Fonte, int Margem);
        ...
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasCODABAR(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasCODE128(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasCODE39(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasCODE93(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasEAN13(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasEAN8(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasISBN(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasITF(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasMSI(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasPDF417(int nCorrecaoErros, int altura, int Largura, int nColunasImpressas, String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasPLESSEY(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasUPCA(String texto);
        ...
        /// <param name="texto">STRING texto do código que será gerado</param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport(DLL)] public static extern int ImprimeCodigoBarrasUPCE(String texto);


        [DllImport(DLL)]  // função apra o qr code
