...
namespace Emiplus.Data.Core
{
    internal class Update
    {
        ...
        public void CheckIni()
        {
            ...
            if (!IniFile.KeyExists("syncAuto", "APP"))
                IniFile.Write("syncAuto", "True", "APP");
            ...
            if (!IniFile.KeyExists("BaixarEstoqueRemessas", "Comercial"))
                IniFile.Write("BaixarEstoqueRemessas", "True", "Comercial");
