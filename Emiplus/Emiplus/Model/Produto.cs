...
namespace Emiplus.Model
{
    ...
    internal class Produto : Model
    {
        public Produto() : base("ITEM")
        {
        }
        ...
        public bool Remove(int id)
        {
            if (Delete("id", id) == 1)
            {
                Alert.Message("Removido!", "Removido com sucesso.", Alert.AlertType.info);
                return true;
            }
        ...
        /// </code>
        /// </example>
        public bool ValidarDados(Produto data)
        {
            var result = ValitRules<Produto>
                .Create()
                .Ensure(m => m.Nome, _ => _
                    .Required()
